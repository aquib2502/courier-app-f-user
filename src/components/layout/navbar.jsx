      ...
      <div className="max-w-full px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <motion.h1
            ...
            className="text-xl sm:text-2xl lg:text-3xl font-extrabold bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent cursor-pointer"
            onClick={() => router.push("/")}
          >
            THE TRACE EXPRESS
          </motion.h1>
        ...
        {/* Mobile Right - Notifications, Wallet, Profile, Hamburger */}
        <div className="flex lg:hidden items-center space-x-2">
            ...
            <AnimatePresence>
              {showNotifications && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 10 }}
                  transition={{ duration: 0.2 }}
                  className="absolute right-0 mt-2 w-80 max-w-[90vw] bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50"
                >
                  <div className="px-4 py-2 border-b border-gray-100 flex justify-between items-center">
                    <h3 className="font-semibold text-gray-700">
                      Notifications
          ...
          {/* Mobile Wallet & Profile (when logged in) */}
          {userData.fullname && (
            <>
              <motion.div
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="flex items-center space-x-1 cursor-pointer p-2 rounded-md bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 border border-green-100 transition-all duration-200"
              >
                <Wallet className="w-4 h-4 text-green-600" />
                <span className="text-green-600 font-medium text-sm">Rs.{balance}</span>
              </motion.div>
              ...
              <div className="relative">
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={toggleProfileMenu}
                  className="flex items-center cursor-pointer p-1 rounded-full bg-emerald-100 hover:bg-emerald-200 transition-all duration-200"
                >
