...
const Ready = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const readyOrders = response.data.data.filter(
  ...
  const generateSerialNumber = async () => {
    try {
      const response = await axios.get(
        "${process.env.NEXT_PUBLIC_API_URL}/api/orders/count/total"
      );
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage your orders ready for shipment
            </p>
          </div>
                      ...
                      <td colSpan="6" className="px-4 py-12 text-center">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-sm text-gray-500 mb-4">
                            You don't have any ready orders at the moment.
                          </p>
                        </div>
                      </td>
                    </tr>
                  ...
                  <table className="w-full border-collapse border border-gray-300 rounded-lg overflow-hidden text-xs">
                    ...
                    <thead>
                      <tr>
                        <th
                          colSpan="2"
                          className="text-center p-2 bg-blue-50 border-b border-gray-300"
                          style={{
                            fontSize: "11px",
                            fontWeight: "bold",
                            color: "#1e40af",
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td
                          className="align-top p-2 border-b border-gray-300"
                          style={{ width: "30%" }}
                        >
                      ...
                      <tr>
                        <td
                          colSpan="2"
                          className="p-2 border-b border-gray-300 bg-gray-50"
                        >
                          <div className="text-xs">
                            <span className="font-semibold">Item: </span>
                            <span>
                              {selectedOrder.productItems?.[0]?.productName ||
                                "Product"}
                            </span>
                            <span className="ml-2 font-medium">
                              Qty:{" "}
                              {selectedOrder.productItems?.[0]
                                ?.productQuantity || "1"}
                            </span>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td
                          colSpan="2"
                          className="p-3 border-b border-gray-300 text-center bg-white"
                        >
                      ...
                      <tr>
                        <td colSpan="2" className="p-2 text-xs bg-gray-50">
                          <div className="flex justify-between text-xs">
                            ...
                            <span>
                              DIM: {selectedOrder.length || "10"}×
                              {selectedOrder.width || "10"}×
                              {selectedOrder.height || "10"}cm
                            </span>
                          </div>
                          <div className="mt-1 text-center">
                            <div className="text-xs text-gray-600">
                              Return: Mumbai, MH 400059, India
                            </div>
                          </div>
                        </td>
                      </tr>
