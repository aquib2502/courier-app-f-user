            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all ${errors[`productName_${index}`] ? 'border-red-300' : 'border-gray-300'
                    }`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all ${errors[`productQuantity_${index}`] ? 'border-red-300' : 'border-gray-300'
                    }`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all ${errors[`productPrice_${index}`] ? 'border-red-300' : 'border-gray-300'
                    }`}
                />
