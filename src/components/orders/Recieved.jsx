  ...
  const records = [
    {
      ...
      orderId: "SG32503122585552",
      customer: "Yvonne Forster",
      details: "0.05 KG | CSB-IV",
      status: "Delivered",
      lastMileAWB: "WG971326654GB",
      carrier: "Royal Mail",
    },
    {
      date: "2025-03-28 21:24",
      orderId: "SG32503228684973",
      customer: "elena contreras",
      details: "0.05 KG | CSB-IV",
      status: "Inwarded",
      lastMileAWB: "LY650783001DE",
      carrier: "DHL",
    },
    {
      date: "2025-03-25 19:22",
      orderId: "SG32503292685934",
      customer: "John Doe",
      details: "0.05 KG | CSB-IV",
      status: "Received",
      lastMileAWB: "LY65078300001",
      carrier: "FedEx",
    },
  ];
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-semibold text-gray-800">Received Orders</h2>
